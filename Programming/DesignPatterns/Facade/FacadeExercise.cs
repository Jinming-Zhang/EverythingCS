    ...
    public class MagicSquareGenerator {
        public List<List<int>> Generate (int size) {
            ...
            for (int i = 0; i < size; i++) {
                square.Add (new Generator ().Generate (size));
            }
            List<List<int>> ints = new Splitter ().Split (square);
            
            return square;
        }
    }
    public static class FacadeExercise {
        public static void FacadeExerciseDemo () {
